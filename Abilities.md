...
### 발동 능력
발동 능력은 (), (), () 아이콘으로 나타나 있습니다. 능력에 하나 이상의 선행 조건(비용 그리고/또는 조건)이 있다면 아이콘 후의 문장에 기록되어 있습니다. 플레이어는 발동 능력을 사용하기 위해서 선행 조건을 반드시 항상 달성해야 합니다. 발동 능력은 3가지로 구분됩니다.

자유 발동 능력 () - 자유 발동 능력은 어떤 `플레이어 시점`에서든 플레이어 능력으로서 발동될 수 있습니다.

반응 발동 능력 () - 반응 발동 능력은 예를 들어 "(반응) 적을 물리친 후:" 와 같이 발동 조건이 만족되는 언제든 발동 할 수 있는 조건을 가진 능력입니다.
...
액션 발동 능력 () - 액션 발동 능력은 조사자 페이즈에서 플레이어의 턴 동안 액션을 사용함으로서, 그리고 각 능력의 비용으로 하나의 액션을 사용함으로서 발동 될 수 있습니다.
